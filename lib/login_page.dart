          ...
          new Container(
            ...
            decoration: new BoxDecoration(
                image: new DecorationImage(
                    colorFilter: new ColorFilter.mode(Colors.black.withOpacity(0.65), BlendMode.darken),
                    image: new AssetImage('assets/images/chengdu.png'),
    ...
    return [
      Padding(
        ...
        child: Column(
          ...
          children: <Widget> [
            AutoSizeText('Today\'s', group: titleGroup, style: TextStyle(fontFamily: 'Helvetica',
            fontWeight: FontWeight.bold, fontSize: 60.0, color: Colors.white), maxFontSize: 70.0, maxLines: 1),
            AutoSizeText('Words', group: titleGroup, style: TextStyle(fontFamily: 'Helvetica',
                fontWeight: FontWeight.bold, fontSize: 60.0, color: Colors.green[300]), maxFontSize: 70.0, maxLines: 1),
          ]
        )
      ),
      Padding(
        ...
        child: AutoSizeText.rich(
          TextSpan(
            ...
            children: <TextSpan>[
              TextSpan(text: 'Don\'t forget the ',
                  style: new TextStyle(
                      color: Colors.white)),
              TextSpan(text: 'words',
                  style: new TextStyle(
                      color: Colors.green[300])),
              TextSpan(text: ' you learned ',
                  style: new TextStyle(
                      color: Colors.white)),
              TextSpan(text: 'today',
                  style: new TextStyle(
